...
public class ProcuringEntitySearchController extends GenericOcvnController {
	...
	public VNOrganization organizationId(@PathVariable String id) {
	...
	/**
	 * Searches the {@link VNOrganization} based on a given text. 
	 * The text has to have minimum 3 characters and max 30
	 * @param request
	 * @return
	 */
