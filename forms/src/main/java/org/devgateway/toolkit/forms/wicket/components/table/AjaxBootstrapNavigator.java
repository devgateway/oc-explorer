...
public class AjaxBootstrapNavigator extends AjaxPagingNavigator {
    ...
    public AjaxBootstrapNavigator(String id, IPageable pageable) {
        this(id, pageable, null);
    }

    public AjaxBootstrapNavigator(String id, IPageable pageable, boolean hideFastPagination) {
        this(id, pageable, null, hideFastPagination);
    }

    public AjaxBootstrapNavigator(String id, IPageable pageable, IPagingLabelProvider labelProvider, boolean hideFastPagination) {
        this(id, pageable, labelProvider);

        this.hideFastPagination = hideFastPagination;
    }

    public AjaxBootstrapNavigator(String id, IPageable pageable, IPagingLabelProvider labelProvider) {
