...
/**
 * @author mpostelnicu Provides built-in backup services. Defaults to the database
...
public class DerbyDatabaseBackupService {
	...
	/**
	*  Use backup.home system variable, if exists, as homedir for backups
	 * If backup.home does not exist try using derby.system.home
