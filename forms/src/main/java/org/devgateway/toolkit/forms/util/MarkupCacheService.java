 ...
 *  org.devgateway.ccrs.web.wicket.page.reports.AbstractReportPage#ResourceStreamPanel#getCacheKey function
 */
@Component
@Profile("reports")
public class MarkupCacheService {
    ...
    public final void flushMarkupCache() {
        ...
        for (String key : keys) {
            // The key for reports markup cache contains the class name so it should end in "ReportPage"
     ...
     * @param buffer
     */
    public void addReportToCache(final String outputType, final String reportName,
                                 final String parameters, final byte[] buffer) {
     ...
     * @return
     */
    public byte[] getReportFromCache(final String outputType, final String reportName,
