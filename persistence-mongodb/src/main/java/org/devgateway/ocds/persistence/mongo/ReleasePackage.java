...
public class ReleasePackage implements Identifiable {
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(uri).append(publishedDate).append(releases).append(publisher)
				.append(license).append(publicationPolicy).toHashCode();
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof ReleasePackage) == false) {
			return false;
		}
		ReleasePackage rhs = ((ReleasePackage) other);
		return new EqualsBuilder().append(uri, rhs.uri).append(publishedDate, rhs.publishedDate)
				.append(releases, rhs.releases).append(publisher, rhs.publisher).append(license, rhs.license)
