...
@JsonPropertyOrder({"date", "rationale", "id", "description", "amendsReleaseID", "releaseID", "changes"})
public class Amendment {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("date", date).append("rationale", rationale).append("id", id)
                .append("description", description).append("amendsReleaseID", amendsReleaseID).append(
                        "releaseID",
                        releaseID).append("changes", changes).append("additionalProperties", additionalProperties)
                .toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(date).append(releaseID).append(changes).append(description).append(id)
                .append(amendsReleaseID).append(additionalProperties).append(rationale).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(date, rhs.date).append(releaseID, rhs.releaseID).append(changes, rhs
                .changes).append(description, rhs.description).append(id, rhs.id).append(amendsReleaseID, rhs
                .amendsReleaseID).append(additionalProperties, rhs.additionalProperties).append(rationale, rhs
                .rationale).isEquals();
    }
