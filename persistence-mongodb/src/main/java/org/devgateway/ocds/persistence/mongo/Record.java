...
public class Record implements Identifiable {
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(ocid).append(releases).append(compiledRelease).toHashCode();
	}
	...
	public boolean equals(Object other) {
		...
		return new EqualsBuilder().append(ocid, rhs.ocid).append(releases, rhs.releases)
