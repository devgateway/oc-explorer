...
public class Document {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(documentType).append(title).append(description).append(url).append(datePublished).append(dateModified).append(format).append(language).append(additionalProperties).toHashCode();
    }
