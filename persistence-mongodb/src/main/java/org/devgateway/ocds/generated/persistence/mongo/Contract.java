...
public class Contract {
     ...
     * Contract ID
     * <p>
     * The identifier for this contract. It must be unique and cannot change within its Open Contracting Process (defined by a single ocid). See the [identifier guidance](http://ocds.open-contracting.org/standard/r/1__0__0/en/key_concepts/identifiers/) for further details.
     * (Required)
     * 
     */
    @JsonProperty("id")
     ...
     * Contract Status
     * <p>
     * The current status of the contract. Drawn from the [contractStatus codelist](http://ocds.open-contracting.org/standard/r/1__0__0/en/schema/codelists/#contract-status)
     * 
     */
    @JsonProperty("status")
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(awardID).append(title).append(description).append(status).append(period).append(value).append(items).append(dateSigned).append(documents).append(amendment).append(implementation).append(additionalProperties).toHashCode();
    }
